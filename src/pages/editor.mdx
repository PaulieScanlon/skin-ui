...
<section className={COMPONENTS}>
  ...
  >
    ...
    <Box sx={{ backgroundColor: "text", p:4, mb: 3, width: "100%" }}/>
    <Label sx={{color: 'text'}}>primary</Label>
    <Box sx={{ backgroundColor: "primary", p:4, mb: 3, width: "100%" }}/>
    <Label sx={{color: 'text'}}>secondary</Label>
    <Box sx={{ backgroundColor: "secondary", p:4, mb: 3, width: "100%" }}/>
    <Label sx={{color: 'text'}}>muted</Label>
    <Box sx={{ backgroundColor: "muted", p:4, mb: 3, width: "100%" }}/>
    <Label sx={{color: 'text'}}>highlight</Label>
    <Box sx={{ backgroundColor: "highlight", p:4, mb: 3, width: "100%" }}/>
    <Label sx={{color: 'text'}}>gray</Label>
    <Box sx={{ backgroundColor: "gray", p:4, mb: 3, width: "100%" }}/>
    <Label sx={{color: 'text'}}>accent</Label>
    <Box sx={{ backgroundColor: "accent", p:4, mb: 3, width: "100%" }}/>
    <Label sx={{color: 'text'}}>darken</Label>
    <Box sx={{ backgroundColor: "darken", p:4, mb: 3, width: "100%" }}/>
  </Flex> 
